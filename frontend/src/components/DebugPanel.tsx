      ...
      <div className="flex flex-wrap items-center justify-between px-5 py-2.5 min-h-[52px] text-sm font-mono gap-3">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2.5">
            <span className="text-[#848e9c] uppercase font-bold text-xs tracking-wider">
              Network
            </span>
            <span
              className={`px-2.5 py-1 rounded-md text-xs font-bold uppercase border ${tierBadgeBg}`}
            >
              {tier}
            </span>
          </div>
        ...
        <div className="flex items-center gap-3">
          <span className="text-sm text-[#94a3b8] font-semibold hidden lg:inline">
            Simulate Tier:
          </span>
          ...
          <div className="h-6 w-px bg-[#1e2638] hidden sm:block" />
